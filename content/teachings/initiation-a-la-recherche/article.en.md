...
![IMRaD structure](https://drive.google.com/uc?export=view&id=TODO_imrad-structure)
...
An introduction should be engaging and convincing, clear and directive.

#### Method
- Study material (corpus)
- Procedure
- Analysis method

#### Results
- Results, precise and concise
- DO NOT GO BEYOND the simple description of results (no interpretation)
- Exactly what is necessary to conclude
- Conclusion taking into account the hypothesis

#### Discussion
- What conclusion based on the results
- How this contributes to the research question
- Opening towards new horizons (new question, new practice, new designs...)

#### Abstract
- **The abstract is not about the article, it is the article.**
- What are the topic and challenge?
- What was done and how?
- What are the results?

Writing an article is not linear; it most often resembles **ITMRMDIDaAaTK**.

### The Pictorial
The pictorial-type article places the image at the centre of its knowledge production. The image then serves to articulate and clarify the knowledge exposed in the pictorial. It becomes at least as important as the text.

The image can become a form of knowledge articulation more important in the pictorial than the text.

A first possible pictorial was archived in 2013 in the ACM library (for NordiCHI). The DIS conference proposed a first track for pictorials in 2014.

Blevis proposes a list of types of images relevant for the pictorial (non-exhaustive list):
- images as traces of fabrication
- images as form of fabrication
- images as captures of the process
- images as ethnography in/of design
- images as commentary on design
- images as aesthetic reflection
- images as social commentary from the design perspective
- images as captures of inspiration
- images of reflection to inform a process
- images as captures of one or more contexts or environments
- images as captures of concepts
- images as captures of materiality.

Examples are in the article (Blevis et al., 2015)

#### Recommendations
- Images contribute to the argumentative development of the article. Like all other arguments, they must be significant and concise (in what they express and in their number).
...
{{<linkBox "Powerpoint Format" "https://dis.acm.org/2021/wp-content/uploads/2020/12/DIS2021-Pictorials-PowerPoint-template_Folder.zip">}}
...
#### DIS2018 Evaluation (adapted)
##### *For the author*
- Does the work require a pictorial format or would it be clearer in textual form?
- Is the production value of the images and/or diagrams of high quality?
- Are images/diagrams privileged over text as the main means of communicating the research contribution?
- Are the design implications clear? These can be analytical, generative, oriented towards synthesis and even manifest.
- Are the societal benefits of the Pictorial clear and in line with the code of ethics and professional conduct of the research community?
- Does each image used in the Pictorial play a significant role and clearly present the idea, alone or with the support of text?
- Does the placement of images and text compose a good narrative?

##### *For the reviewer*
- Does it leverage an image-based format, or would a text-based format be more suitable for the Pictorial?
- Does the Pictorial bring a contribution to the research community (and beyond)?
- Does it present a clear and logical argument that makes the paper's claim credible?
- Does it represent a sufficiently high visual quality to convey the Pictorial's message?
- Do you think it transforms into a visually appealing presentation? What would that format be?
