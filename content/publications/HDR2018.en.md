...
abstract: "The Japanese tea ceremony is an experiential moment of aesthetics and ethics of the everyday, a harmony between objects, beings, places, and practices. It underlines that everyday objects, the heart of our material culture, exhibit a profound beauty, uphold a remarkable ethics, and yet go unnoticed. At the crossing of a reflection on a Japanese approach to design through the study of kansei, and a reflection on design in HCI based on embodiment theories, this research inquires first into the western cultural hegemony of design in HCI, and second sets a cultural decentration of the discipline, taking Japanese philosophy and culture as theory. This results in a novel perspective on design and designing, supported by an ethics of relation, an experience of thusness, and an aesthetics of irregularities. This perspective invites design to enchant the everyday, enabling us to consider details of reality as it is lived, and to create unexpected moments, a source of surprises and new possible outcomes. Therefore, inviting to culturally decentre design, this research suggests an original approach to design for the everyday, and contributes to finding in it a major aesthetic and ethical source, towards human development, as well as one’s sensitivity, and one’s values."
...
***Transcription of my defence for Habilitation***
...
First of all, because UTC has put Technologies and Human Sciences at the centre of its pedagogical project in engineering, and has dedicated one of its educational programmes to industrial design. A vision in which I find myself completely.  
...
And finally, I will explain the consequences of this turning point for design, and in particular, for everyday life rituals.
...
- Constructive design research, which invites experimentation with devices designed for research. Research-through-Design (Koskinen et al., 2012) is a major marker.
...
Finally, this approach also requires a project so that design can act and contribute to research. In Sennett’s words and adapting them to design, Hummels describes this request to localise the research question, which can then be followed by a reflection in action, allowing it to be questioned, and a reflection on action to inquire the research question a fortiori, beyond the project itself.
...
In particular, I have been interested in the Way of Tea, which Okakura (1906) describes in his famous book The Book of Tea as the cult of the beautiful of the ordinary in the everyday. And I have been especially interested in the Japanese tea ceremony, which is a ritualised experience of the Way of Tea, established by Rikyu in the 16th century.

To illustrate what I saw there, I would like to take the example of a short moment during the ceremony, illustrated by the photo you see here. Once the light tea has been served, the main guest asks the host if he or she could view the objects used for tea. The host then introduces him to the chashaku and the chaire, the chashaku being the small spatula to take tea out of the chaire, which is the tea container. The chaire diameter is about one-third the length of the chashaku. The host places the chashaku two mats apart from the edge of the tatami in front of the main guest, and aligns the centre of the chaire with the centre of the chashaku. Once the host has withdrawn into the water room, i.e., the kitchen, the guest approaches the two objects so that his knees are two mats from the chashaku. Sitting in seiza, he will then be able to comfortably manipulate and contemplate the two objects presented to him, in a culturally Japanese comfort.

What impressed me here is that Rikyu has made an aesthetic proposition towards harmony that corresponds to a system of values (not aimed at effectiveness or efficiency), with aesthetic, ethical and social concerns, and that enables the realisation of beauty.
...
The idea that the formalisation of the Japanese tea ceremony responds to a “social expectation of its time” already invites us to rethink the ritual not as a fixed repetition of a sequence of actions, but as a practice of daily life re-interpretable in a time and place.

Moreover, the realisation of an aesthetic proposal enables the perspective of this aesthetic proposal by Japanese thought, and opens on the notions of contexture and temporality of the daily experience, notions that we will question later.
...
- The ordinary focuses on what appears classic or usual, and useful for everyday life. It also invites us to consider habitability, a concept dear to Alain Findeli.
- Finally, the void concerns a space of possibilities left open by the design, to be filled by the user (or interactant) with the artefact, in order to adapt the value proposal to one’s place and time within one’s daily life.
...
This decentration invites us to redefine the ritual not as an identical repetition of a sequence of actions, but as an aesthetic proposal that allows us to reconsider every time in our daily lives.
...
How can the temporality of the ritual be characterised, for example, differently from the flow theory, proposed by Mihaly Csikszentmihalyi, also aiming at efficiency? We are aiming here at an aesthetic proposal that questions temporality, that invites us to take time: in this proposal, what values stopping to listen to music, contemplating a landscape, etc. This is another major issue addressed by this research program.
