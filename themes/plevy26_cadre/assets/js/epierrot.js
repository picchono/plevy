...
function MenuToggle() {
  document.querySelectorAll("h2[class^='section-']").forEach(function (el) {
    el.addEventListener("click", function () {
      ...
      if (vw > 768) {
        document.querySelector('div.mainsection').scroll({ top: document.querySelector('div.' + secti + '.startSection').offsetTop - 63, behavior: 'smooth' });
      } else {
        window.scroll({ top: document.querySelector('div.' + secti + '.startSection').offsetTop - 63, behavior: 'smooth' });
      }
